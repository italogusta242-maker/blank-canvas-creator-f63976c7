...
const navItems = [
  ...
  { title: "Faturamento", path: "/admin/faturamento", icon: DollarSign },
  { title: "Desafios", path: "/admin/desafios", icon: Layout },
  { title: "Cupons", path: "/admin/cupons", icon: Tag },
  // Funil / VSL removed from nav
        ...
        <div className="flex items-center justify-between p-4 border-b border-border">
          {!collapsed && (
            <div className="flex items-center gap-2">
              ...
              <span className="font-cinzel text-sm font-bold text-gold">VISÃO GERAL</span>
            </div>
          )}
          <button
