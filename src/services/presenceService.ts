...
/**
 * Re-track presence metadata (name/role) without reinitialising the channel.
 * Call this when the profile loads asynchronously after the initial subscribe.
 */
export function updatePresenceMeta(userId: string, meta: { name?: string; role?: string }) {
