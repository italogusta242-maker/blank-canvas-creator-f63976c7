            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                {userData.fisiculturismo === "sim" && (
                  <div className="space-y-3 pl-3 border-l-2 border-primary/30">
                    <p className="text-xs text-muted-foreground text-center italic">Conte para nós mais detalhes sobre seu objetivo de competição nos campos abaixo.</p>
                  </div>
                )}
                    ...
                    <button 
                      ...
                      className={`w-full text-left p-4 rounded-xl border-2 transition-all ${
                        userData.planner_type === "constancia" 
                          ? "border-[#FF4B8B] bg-[#FF4B8B]/10" 
                          : "border-border bg-card hover:border-[#FF4B8B]/50"
                      }`}
                    >
                      <div className="flex items-center gap-3">
                        <div className={`p-2 rounded-lg ${userData.planner_type === "constancia" ? "bg-[#FF4B8B]/20" : "bg-secondary"}`}>
                          <Dumbbell className={userData.planner_type === "constancia" ? "text-[#FF4B8B]" : "text-muted-foreground"} size={20} />
                        </div>
                        <div>
                          <h4 className={`font-cinzel font-bold ${userData.planner_type === "constancia" ? "text-[#FF4B8B]" : "text-foreground"}`}>
