...
/**
 * Fire-and-forget: registra uma tentativa de login falha para diagnóstico
 * de problemas de acesso por celular/4G. Nunca lança erro.
 */
export function logAuthFailure(email: string | undefined, errorMessage: string): void {
  try {
    ...
    void (supabase as any)
      ...
      .then(() => {})
      .catch((e: any) => console.warn("logAuthFailure failed:", e?.message));
  } catch (e) {
