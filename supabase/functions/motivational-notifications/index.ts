...
const RESCUE_19H_MESSAGES = [
  ...
  "A sua Chama está por um fio. Faltam poucas horas para o dia acabar. Você vai mesmo jogar todos esses dias de esforço no lixo? O mascote está chorando... 🥺",
  "O sofá tá gostoso, né? Mas ele não vai te dar shape. Levanta e faz o que tem que ser feito. 🔥",
